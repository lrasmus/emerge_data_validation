module SubmissionsHelper
  def get_data_from_params data_dictionary_param, data_dictionary_name, data_file_param, data_file_name
    ...
    unless data_dictionary.blank?
      ...
      @data_dictionary_results[:file_name] = data_dictionary_name
      unless data_file.blank?
        ...
        @data_file_results[:file_name] = data_file_name
      end
    end
  end
